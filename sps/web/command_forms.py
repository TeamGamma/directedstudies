...
_money_value_input = dict(name='amount', label='Amount', help='Amount in dollars')
_quantity_input = dict(name='quantity', label='Quantity', help='Quantity of stock')
_buy_trigger_input = dict(name='amount', label='Trigger Price', help='Buy will be triggered when stock price goes below this')
_sell_trigger_input = dict(name='amount', label='Trigger Price', help='Sell will be triggered when stock price goes above this')
